-- 002_tripadvisor_connections.sql
...
-- Stores ONLY data returned by the official Tripadvisor API (Terra by default, or the
-- legacy Content API in fallback mode). Tripadvisor is never scraped; this table never
-- stores fabricated or scraped reviews, only the limited recent review set the API returns.
